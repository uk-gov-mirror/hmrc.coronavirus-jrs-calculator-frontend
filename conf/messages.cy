...
confirmation.no.nic.pension.nextSteps.li.3 = 3. Defnyddiwch y gyfrifiannell eto ar gyfer unrhyw gyflogeion eraill sydd ar ffyrlo yn ystod y cyfnod hawlio hwn ({0} {1} i {2} {3}), a gwnewch nodyn o’r canlyniadau.
...
phaseTwoDetailedBreakdown.no.nic.pension.p1.regular = You told us this employee gets paid a regular amount each time. We’ve worked out their daily earnings and multiplied by the number of furlough days in each pay period. The furlough grant is 80% of this.
...
phaseTwoDetailedBreakdown.no.nic.pension.p1.cylb.2 = Method 1: we’ve taken the amounts they were paid for equivalent pay periods in 2019 and applied this to the number of furlough days in each pay period.
