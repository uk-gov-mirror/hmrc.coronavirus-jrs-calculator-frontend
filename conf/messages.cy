...
payMethod.title = Sut mae’r cyflogai hwn yn cael ei dalu?
payMethod.heading = Sut mae’r cyflogai hwn yn cael ei dalu?
...
rootPage.p3 = Mae’r gyfrifiannell yn gweithio i’r mwyafrif o gyflogeion sy’n cael eu talu bob wythnos, bob 2 wythnos, bob 4 wythnos neu bob mis.
rootPage.p4 = O 1 Gorffennaf ymlaen, gellir dod â chyflogeion yn ôl i’r gwaith am rai o’u horiau arferol. Gall y gyfrifiannell ystyried hyn.
rootPage.p5 = Nid yw’n gweithio ar hyn o bryd i gyflogeion sydd:
rootPage.p5.l1 = wedi dychwelyd o absenoldeb statudol, megis absenoldeb mamolaeth, yn ystod y 3 mis diwethaf
rootPage.p5.l2 = yn cael taliadau cyfarwyddwr
rootPage.p5.l3 = wedi’u trosglwyddo o dan TUPE
rootPage.p5.l4 = wedi cael eu cyflogi ar adegau ar wahân drwy gydol y flwyddyn
...
rootPage.beforeYouStart.p1.l2 = dyddiad dod i ben yr hawliad (sicrhewch fod hwn yn cyd-fynd â’r rhediad nesaf o’ch cyflogres)
...
rootPage.beforeYouStart.p3.link = Steps to take before calculating your claim (opens in new tab)
...
partTimeNormalHours.whatToInclude.p = For an employee on fixed hours whose pay does not depend on hours worked:
partTimeNormalHours.whatToInclude.p2 = If this employee was sick, on annual leave, or on family-related statutory leave during the last pay period ending before 20 March, work out their usual hours as if they had not taken that leave.
partTimeNormalHours.whatToInclude.ol.1 = Start with hours this employee was contracted for at the end of the last pay period ending before 20 March.
partTimeNormalHours.whatToInclude.ol.2 = Divide by the number of calendar days in the repeating working pattern, including non-working days.
partTimeNormalHours.whatToInclude.ol.3 = Multiply by the number of calendar days in the pay period (or partial pay period) you're claiming for.
partTimeNormalHours.whatToInclude.ol.4 = Round up or down if the result isn't a whole number.
