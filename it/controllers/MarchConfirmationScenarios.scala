...
object MarchConfirmationScenarios extends IntegrationSpecBase with CreateRequestHelper with CustomMatchers
  with BaseITConstants with ITCoreTestData {

  val marchFourWeeklyScenarios: Seq[(String, Seq[(UserAnswers, BigDecimal)])] = Seq("March Fixed Four Weekly Scenarios" -> Seq(
    emptyUserAnswers
  ...
  val marchMonthlyScenarios: Seq[(String, Seq[(UserAnswers, BigDecimal)])] = Seq("March Fixed Monthly Scenarios" -> Seq(
    emptyUserAnswers
      .withFurloughStatus(FurloughStatus.FurloughOngoing)
  ...
  val marchTwoWeeklyScenarios: Seq[(String, Seq[(UserAnswers, BigDecimal)])] = Seq("March Fixed Two Weekly Scenarios" -> Seq(
    emptyUserAnswers
      .withFurloughStatus(FurloughStatus.FurloughOngoing)
  ...
  val marchWeeklyScenarios: Seq[(String, Seq[(UserAnswers, BigDecimal)])] = Seq("March Fixed Weekly Scenarios" -> Seq(
    emptyUserAnswers
      .withFurloughStatus(FurloughStatus.FurloughOngoing)
  ...
  val marchVariableFourWeeklyScenarios: Seq[(String, Seq[(UserAnswers, BigDecimal)])] = Seq("March Variable Four Weekly Scenarios" -> Seq(
    emptyUserAnswers
      .withFurloughStatus(FurloughStatus.FurloughEnded)
  ...
  val marchVariableMonthlyScenarios: Seq[(String, Seq[(UserAnswers, BigDecimal)])] = Seq("March Variable Monthly Scenarios" -> Seq(
    emptyUserAnswers
      .withFurloughStatus(FurloughStatus.FurloughEnded)
  ...
  val marchVariableTwoWeeklyScenarios: Seq[(String, Seq[(UserAnswers, BigDecimal)])] = Seq("March Variable Two Weekly Scenarios" -> Seq(
    emptyUserAnswers
      .withFurloughStatus(FurloughStatus.FurloughEnded)
  ...
  val marchVariableWeeklyScenarios: Seq[(String, Seq[(UserAnswers, BigDecimal)])] = Seq("March Variable Weekly Scenarios" -> Seq(
    emptyUserAnswers
      .withFurloughStatus(FurloughStatus.FurloughEnded)
