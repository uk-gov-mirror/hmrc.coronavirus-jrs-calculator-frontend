...
trait PageGenerators {
  ...
  implicit lazy val arbitraryPreviousFurloughPeriodsPage: Arbitrary[PreviousFurloughPeriodsPage.type] =
    Arbitrary(PreviousFurloughPeriodsPage)
  ...
  implicit lazy val arbitraryFurloughInLastTaxYearPage: Arbitrary[FurloughInLastTaxYearPage.type] =
    Arbitrary(FurloughInLastTaxYearPage)

  implicit lazy val arbitraryEmployeeRTISubmissionPage: Arbitrary[EmployeeRTISubmissionPage.type] =
    Arbitrary(EmployeeRTISubmissionPage)

  implicit lazy val arbitraryRegularLengthEmployedPage: Arbitrary[RegularLengthEmployedPage.type] =
    Arbitrary(RegularLengthEmployedPage)

  implicit lazy val arbitraryPayPeriodsListPage: Arbitrary[PayPeriodsListPage.type] =
    Arbitrary(PayPeriodsListPage)

  implicit lazy val arbitraryPartTimeHoursPage: Arbitrary[PartTimeHoursPage.type] =
    Arbitrary(PartTimeHoursPage)
