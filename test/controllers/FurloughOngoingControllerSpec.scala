  ...
  "furloughOngoing Controller" must {
    ...
    "return OK and the correct view for a GET" in {
      ...
      contentAsString(result) mustEqual
        view(form, phaseOne.start)(dataRequest, messages).toString
    }
    ...
    "return OK and the correct view for a GET if phase two" in {
      ...
      status(result) mustEqual OK
      contentAsString(result) mustEqual
        view(form, phaseTwo.start)(dataRequest, messages).toString
    }
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      status(result) mustEqual OK
      contentAsString(result) mustEqual
        view(form.fill(FurloughStatus.values.head), phaseOne.start)(dataRequest, messages).toString
    }
    ...
    "return a Bad Request and errors when invalid data is submitted" in {
      ...
      contentAsString(result) mustEqual
        view(boundForm, phaseOne.start)(dataRequest, messages).toString
    }
