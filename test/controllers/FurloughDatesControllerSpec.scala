...
import models.{FurloughDates, NormalMode}
  ...
  "FurloughDates Controller" must {
    ...
    "return OK and the correct view for a GET" in {
      ...
      contentAsString(result) mustEqual
        view(form, NormalMode, claimPeriodStart, claimPeriodEnd)(request, messages).toString
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = userAnswersWithClaimStartAndEnd.set(FurloughDatesPage, FurloughDates.values.head).success.value
      ...
      contentAsString(result) mustEqual
        view(form.fill(FurloughDates.values.head), NormalMode, claimPeriodStart, claimPeriodEnd)(request, messages).toString
    ...
    "return a Bad Request and errors when invalid data is submitted" in {
      ...
      contentAsString(result) mustEqual
        view(boundForm, NormalMode, claimPeriodStart, claimPeriodEnd)(request, messages).toString
