...
import models.{Amount, CalculationResult, FullPeriod, FurloughOngoing, PaymentDate, Period, PeriodBreakdown, PeriodWithPaymentDate}
...
class ConfirmationControllerSpec extends SpecBaseWithApplication {
  ...
  "Confirmation Controller" must {
    ...
    "return OK and the correct view for a GET" in {
      ...
      contentAsString(result) mustEqual view(meta, breakdown, frontendAppConfig.calculatorVersion, FurloughOngoing.No)(request, messages).toString
