...
class PensionCalculatorSpec extends SpecBase with ScalaCheckPropertyChecks with CoreTestDataBuilder {
  ...
  "Returns 0.00 for Pension grant if not eligible for Pension grant full period" in new PensionCalculator {
    val payment = regularPaymentWithFullPeriod(2000.00, fullPeriodWithPaymentDate("2020-03-01", "2020-03-31", "2020-03-31"))
  ...
  private lazy val fullPeriodScenarios = Table(
    ...
    (
      Monthly,
      Amount(1600.00),
      regularPaymentWithFullPeriod(2000.00, fullPeriodWithPaymentDate("2020-03-01", "2020-03-31", "2020-03-31")),
      Amount(32.64)
    ),
    (
      Monthly,
      Amount(600.00),
      regularPaymentWithFullPeriod(750.00, fullPeriodWithPaymentDate("2020-03-01", "2020-03-31", "2020-03-31")),
      Amount(2.64)
    )
  )
