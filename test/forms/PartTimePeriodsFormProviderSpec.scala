...
class PartTimePeriodsFormProviderSpec extends CheckboxFieldBehaviours with Generators with ScalaCheckPropertyChecks {

  val form = new PartTimePeriodsFormProvider()()
