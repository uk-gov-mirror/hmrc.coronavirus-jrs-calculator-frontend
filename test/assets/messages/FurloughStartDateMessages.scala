...
object FurloughStartDateMessages {
  ...
  val extensionP2 =
    "If this employee was not on your payroll on 30 October 2020 and was furloughed before 1 May 2021, then use the date 1 May 2021."
  val extensionP3 =
    "Employees must be on your payroll and therefore appear in your Real Time Information (RTI) Full Payment Submissions (FPS) on or before 2 March 2021 to be eligible."
}
