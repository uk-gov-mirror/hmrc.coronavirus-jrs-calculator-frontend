...
class AdditionalPaymentStatusPageSpec extends PageBehaviours {

  "AdditionalPaymentStatusPage" must {

    beRetrievable[AdditionalPaymentStatus](AdditionalPaymentStatusPage)
